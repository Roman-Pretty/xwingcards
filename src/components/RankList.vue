    ...
    <div class="flex flex-row gap-4 flex-wrap max-w-full">
      ...
      >
        ...
        <div v-if="rank.optionalslots?.length" class="flex items-center justify-center gap-2 flex-wrap">
          <span
            v-for="(slot, index) in rank.optionalslots"
            :key="slot"
            class="font-[xwing] text-2xl font-extralight opacity-60 -mt-1"
          >
        ...
        <div v-if="rank.ships?.length" class="flex items-center justify-center gap-2 flex-wrap">
          <span
            v-for="slot in rank.ships"
            :key="slot"
            class="font-[ships] text-2xl font-extralight opacity-60 -mt-1"
          >
            {{ slot }}
          </span>
        </div>
    ...
    <dialog id="confirm_rank_modal" class="modal">
      <div class="modal-box bg-neutral-800 text-white">
        ...
        <p class="mb-4">
          ...
          <span class="font-[xwing] text-lg">Ì</span>{{ pendingRank?.xp }} XP?
        </p>
