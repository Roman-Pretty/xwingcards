<template>
  <div class="flex flex-row gap-4 flex-wrap mb-4">
    <div
      v-for="ship in ships"
      :key="ship.ship"
      ...
      :class="{
        ...
        'bg-yellow-800 hover:scale-105': getShipStatus(ship) === 'owned',
        'hover:bg-yellow-700 hover:scale-105 bg-neutral-800': getShipStatus(ship) === 'available',
