...
export const usePilotStore = defineStore("pilotStore", {
  state: () => ({
    pilots: [
      { id: "1", name: "Wedge", rank: 3, xp: 10, class: "Ace", selectedCards: [], ownedCards: [], ships: ["Y-Wing", "X-Wing"], selectedShip: "X-Wing" },
      { id: "2", name: "Luke", rank: 2, xp: 15, class: "Hero", selectedCards: [], ownedCards: [], ships: ["X-Wing"], selectedShip: "X-Wing" },
    ],
    currentPilotId: null,
  }),
